    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label className="text-gray-700 text-sm font-bold flex-1">
                ...
                <textarea
                    rows={10}
                    className="border rounded w-full py-1 px-2 font-normal" {...register("description", { required: "This field is required" })}></textarea>
                {errors.description && (
            ...
            <label className="text-gray-700 text-sm font-bold max-w-[50%]">
                ...
                <input
                    type="number"
                    min={1}
                    className="border rounded w-full py-1 px-2 font-normal" {...register("pricePerNight", { required: "This field is required" })}></input>
